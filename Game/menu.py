...
def showMenu(screen, SCREEN_WIDTH):
    level_0 = Button(
    tuple([237,194,46]), 200-70, 275, 45, 45, "Level 0")
    level_1 = Button(
    tuple([237,194,46]), 270-70, 275, 45, 45, "Level 1")
    running = True
    current_level = 0
    ...
    while running:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if play.isOver(pos):
                        if level_selected != False:
                            subprocess.call("python /home/shogo/master/qc/Zenith-zealots/Game/game.py", shell=True)
            ...
            screen.blit(theme_text, (200, 200))
